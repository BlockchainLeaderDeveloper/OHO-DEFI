...
const AccountElement = styled.div<{ active: boolean }>`
  ...
  background-color: ${({ theme, active }) => (!active ? theme.bg1 : 'rgb(42 68 113)')};
  border-radius: 12px;
  white-space: nowrap;
  width: 100%;
  color: white;
  ...
  return (
    <HeaderFrame>
      ...
      <HeaderRow>
        ...
        <h1 style={{ "width": "300px", "marginLeft": "20px","color":"white" }}>OHO Swap</h1>
        ...
        <HeaderElement>
            ...
            <UNIWrapper onClick={toggleClaimModal}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto' }}>
                <TYPE.white padding="0 2px">
                  {claimTxn && !claimTxn?.receipt ? <Dots>Claiming OHO</Dots> : 'Claim UNI'}
                </TYPE.white>
              </UNIAmount>
              <CardNoise />
            </UNIWrapper>
          ...
          {!availableClaim && aggregateBalance && (
            <UNIWrapper onClick={() => setShowUniBalanceModal(true)}>
              <UNIAmount active={!!account && !availableClaim} style={{ pointerEvents: 'auto', background: 'rgb(42 68 113)' }}>
                {account && (
                  <HideSmall>
                    <TYPE.white
                      style={{
      ...
      <HeaderLinks style={{ "position": "absolute" }}>
        <div style={{"backgroundColor":"white", "display":"flex", "borderRadius":"18px", "paddingTop":"5px","paddingBottom":"5px"}}>
