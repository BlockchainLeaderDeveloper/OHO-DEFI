...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bg1: darkMode ? '#212429' : '#f7f3f0',
    //autonio ui change 27-02-2021
    bg2: darkMode ? '#2F3641' : '#aabad8',
    //autonio ui change 27-02-2021
    bg3: darkMode ? '#40444F' : '#aabad8',
...
export const TYPE = {
  ...
  black(props: TextProps) {
    return <TextWrapper fontWeight={600} color={'black'} margin={'auto'} fontSize={'26px'} {...props} />
  },
...
html {
  color: black;
  background:linear-gradient(0deg, #f5dfdf, #d2e1ef);
